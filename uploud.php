...
<div class="col-sm-9 col-xs-12 qs-form-item qs-form-control">
  <input style="width: 308px;height: 30px;" class="form-cntrol " tybe="text" name="name" required/>
</div>
...
<div class="col-sm-9 col-xs-12 qs-form-item qs-form-control">
  <input style="width: 308px;height: 30px;"  class="form-cntrol " tybe="text" name="link" required/>
</div>
...
<div class="col-sm-9 col-xs-12 qs-form-item qs-form-control">
  <input value="com.store.app" style="width: 308px;height: 30px;"  class="form-cntrol " tybe="text" name="b" required/>
</div>
...
<br>
        ...
        <br>
         <br>
        <input class="add" type="submit" value="اضافة تطبيق" name="add">
    </form>
    </div>
